...
void loop()  // Main code, to run repeatedly
{
  // Speak some text
  emicSerial.print('S');
  emicSerial.print("Hello my name is Susan. I am using an synthetic voice machine to communicate. Please give me sufficient time to respond.");  // Send the desired string to convert to speech
  emicSerial.print('\n');
